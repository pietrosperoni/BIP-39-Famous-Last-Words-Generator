...
def read_roll(number_dices):
    ...
    while (dices_left>0):
        print "Roll %d 8-sided dice. Write the result here. If you want you can click RETURN half way and I will tell you how many dice are left." % dices_left
        roll=raw_input()
...
while True:
    string_words=raw_input("Write the number of words you want to use. Options (12, 15, 18, 21, 24). Some wallet only permit 12 and 24.\n")
